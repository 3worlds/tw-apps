...
public class VersionSettings {
	...
	protected static String ORG = "au.edu.anu.tw-apps";
	
	/** The name of the ivy module (this will be the name of the generated jar file for 
	 * dependent projects).*/
	protected static String MODULE = "tw-apps";
	...
	protected static String DESCRIPTION = 
		"This module contains UI-independent code for ModelMaker and ModelRunner.";
	...
	protected static String[][] DEPS = { 
			{"fr.ens.biologie", "generics", "+", null},
			{"au.edu.anu.rscs.aot", "omugi", "+", null},
			{"fr.cnrs.iees.tw-core", "tw-core", "+", null},
			{"au.edu.anu.rscs.aot", "aot", "+", null},
