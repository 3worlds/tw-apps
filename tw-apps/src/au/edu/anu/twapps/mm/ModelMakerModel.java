/**************************************************************************
 *  TW-MM - ThreeWorlds ModelMaker                                        *
 *                                                                        *
 *  Copyright 2018: Jacques Gignoux & Ian D. Davies                       *
 *       jacques.gignoux@upmc.fr                                          *
 *       ian.davies@anu.edu.au                                            * 
 *                                                                        *
 *  TW-MM is the UI-independent code for ModelMaker                       *
 *                                                                        *
 **************************************************************************                                       
 *  This file is part of TW-MM (ThreeWorlds-ModelMakert).                 *
 *                                                                        *
 *  TW-MM is free software: you can redistribute it and/or modify         *
 *  it under the terms of the GNU General Public License as published by  *
 *  the Free Software Foundation, either version 3 of the License, or     *
 *  (at your option) any later version.                                   *
 *                                                                        *
 *  TW-MM is distributed in the hope that it will be useful,              *
