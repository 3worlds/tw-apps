...
public class EdgeSimpleProperty extends EdgeNamedAndLabelled implements SimplePropertyList {
	private SimplePropertyList properties;

	protected EdgeSimpleProperty(Node start, Node end, String label, String name, EdgeFactory factory) {
		super(start, end, label, name, factory);
	}

	protected EdgeSimpleProperty(Node start, Node end, String label, String name, SimplePropertyList properties,
			EdgeFactory factory) {
